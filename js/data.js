...
(function (global) {
  ...
  const DEFAULT_DATA = {
    hobbies: [
      ...
      {
        id: "h2",
        title: "Suonare la chitarra",
        description: "Chitarrista acustico autodidatta. La musica è il mio modo di rilassarmi dopo una lunga giornata di studio.",
        image: "https://images.unsplash.com/photo-1510915361894-db8b60106cb1?w=800&q=80&auto=format&fit=crop",
      },
      {
        id: "h3",
        title: "Escursionismo",
        description: "Esploro sentieri nei fine settimana. Niente batte la vista dalla cima di una montagna.",
      ...
      },
      {
        id: "h6",
        title: "Lettura",
        description: "Fantascienza e saggistica su tecnologia, design e comportamento umano.",
